   ...
   (lambda (e i compare)
     (let* ((module-name (cadr e))
       ...
       `(module ,module-name (matrix?
          ...
          (bind ,(format "int ~a_fwrite(FILE *, csl_matrix)" file-prefix))
          (bind-rename ,(string-append file-prefix "_fread") "%matrix-fread")
          (bind ,(format "int ~a_fread(FILE *, csl_matrix)" file-prefix))
          (bind-rename ,(string-append file-prefix "_fprintf") "%matrix-fprintf")
          (bind ,(format "int ~a_fprintf(FILE *, csl_matrix, char *)" file-prefix))
          (bind-rename ,(string-append file-prefix "_fscanf") "%matrix-fscanf")
          (bind ,(format "int ~a_fscanf(FILE *, csl_matrix)" file-prefix))
