...
(module gsl.vector.char ()
  ...
  (foreign-declare "#define _TYPE _char")
  (foreign-declare "#define TYPE char")
  (foreign-declare "#define C_SIZEOF_TYPE C_SIZEOF_FIX_BIGNUM")
  (foreign-declare "#define C_MAKE_TYPE C_int_to_num")
  (foreign-declare "#include <gsl/gsl_vector_char.h>")
  (define-foreign-type TYPE byte)
